  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-2xl max-h-[90vh] overflow-hidden bg-white rounded-2xl shadow-2xl transform transition-all duration-300 scale-100 animate-in slide-in-from-bottom-4">
        {/* Gradient header */}
        <div className="relative bg-gradient-to-r from-indigo-600 via-purple-600 to-blue-600 px-6 py-6">
          {/* Background pattern */}
          ...
          <div className="relative flex items-center justify-between">
            <div>
              ...
              <p className="text-indigo-100 text-sm">Add a new task to your project</p>
            </div>
            <button
              onClick={handleClose}
          ...
          <form onSubmit={handleSubmit(handleCreateTask)} className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  className="flex-1 px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white"
                />
                <Button
                  type="button"
                  onClick={addTag}
                  className="px-4 py-3 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-xl hover:from-indigo-600 hover:to-purple-700 transition-all duration-200 shadow-md hover:shadow-lg"
                >
                  Add
                </Button>
              </div>
            ...
            <div className="flex items-center justify-end gap-3 pt-6 border-t border-gray-200">
              ...
              <Button
                type="submit"
                disabled={isLoading}
                className="px-8 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl hover:from-indigo-700 hover:to-purple-700 transition-all duration-200 shadow-md hover:shadow-lg font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
              >
                {isLoading ? (
                  <>
